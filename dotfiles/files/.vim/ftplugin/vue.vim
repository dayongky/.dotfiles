...
autocmd FileType vue autocmd FileWritePre    * :call TrimWhiteSpace()
autocmd FileType vue autocmd FileAppendPre   * :call TrimWhiteSpace()
autocmd FileType vue autocmd FilterWritePre  * :call TrimWhiteSpace()
autocmd FileType vue autocmd BufWritePre     * :call TrimWhiteSpace()
